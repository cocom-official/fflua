...
#define TO_METATABLE_NAME(x) op_tool_t::to_metatable_name((x)).c_str()
    ...
    {
        real_class_property_processor_t() : index_impl_func(NULL),
    ...
    fflua_register_t<CLASS_TYPE, CTOR_TYPE>::fflua_register_t(lua_State *ls_, const string &class_name_, string inherit_name_) : m_ls(ls_),
