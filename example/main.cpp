...
//! lua talbe 可以自动转换为 stl 对象
void dummy(map<string, string> ret, vector<int> a, list<string> b, set<int64_t> c)
{
    printf("in %s begin ------------\n", __FUNCTION__);
...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        //! 调用 lua 函数，stl 类型作为参数，自动转换为 lua table
